    ...
    <article className="rounded-2xl border border-stone-200 bg-white p-4">
      ...
      {review.sellerReply ? (
        <div className="mt-4 rounded-xl bg-stone-50 p-3">
          ...
          <p className="mt-1 text-sm text-gray-700">{review.sellerReply}</p>
        </div>
      ) : null}
    </article>
  );
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          ...
          {summaryQuery.isLoading ? (
            <div className="mt-3 h-7 w-48 animate-pulse rounded bg-stone-100" />
            ...
            <p className="mt-3 inline-flex items-center gap-2 rounded-full bg-stone-100 px-3 py-1.5 text-sm font-semibold text-gray-700">
          ...
          <div className="mt-4 rounded-2xl border border-amber-100 bg-amber-50/70 p-4">
            <p className="text-sm font-semibold text-gray-900">
              Reviews can be submitted from your delivered orders.
            </p>
            <p className="mt-1 text-sm leading-6 text-gray-600">
              After your order is delivered, you will receive a review link and
              can also find it in Profile - Orders.
            </p>
          </div>
        </div>
        ...
        {reviewsQuery.isLoading ? (
          ...
          <div className="rounded-xl border border-dashed border-stone-300 bg-stone-50 p-6 text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Buyer reviews will appear here after verified purchases are
              reviewed.
            </p>
          </div>
        ) : (
